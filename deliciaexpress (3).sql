...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2021 a las 22:58:13
...
(4, 'Camilo ', 'camilocc@gmail.com', '3224752670', '6d902da023541bdb808ee09a5effd943', 'Juridica', '123456787654', 'Dominos', '7152345', 'Soacha');
...
(57, 'Jhon ', 'Cortes', 'jhoncor@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 2, 2, ''),
...
(69, 'Jhon Alexander', 'Cortes Pedraza', 'jhonc@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 4, 2, 'Sanitas'),
(71, 'Prueba', 'dsdf', 'juanp@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 4, 2, 'Salud Vida');
...
--
ALTER TABLE `restaurantes`
  MODIFY `IdRestaurantes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `usuarios`
  MODIFY `IdUsuarios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
